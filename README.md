...
当前版本为 **v0.6.0**。拾序正在从工具管理软件升级为以 Today、Project Space、Work Mode 和 Hermes Intelligence 为核心的个人工作操作系统。
...
- **Project Space 与 AI 工作流**：项目集中管理文件、任务、时间和 AI 记录；Hermes 作为全局侧边助手接入 Gateway / ACP，也支持 OpenAI 兼容接口。
...
- 当前版本：[v0.6.0](https://github.com/byc159357-wq/shixu/releases/tag/v0.6.0)
