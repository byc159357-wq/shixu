...
当前版本为 **v0.7.0**。拾序正在从工具管理软件升级为以 Today、Project Space、Work Mode 和 Hermes Intelligence 为核心的个人工作操作系统。
...
- **Project Space 与 AI 工作流**：项目集中管理文件、任务、时间和 AI 记录；Hermes 作为三栏 AI 工作中心接入 Gateway / ACP，也支持 Ctrl + Space 唤醒 Command Mode 和 OpenAI 兼容接口。
